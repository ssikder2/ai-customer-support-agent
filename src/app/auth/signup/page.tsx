      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 border-0 shadow-lg">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#2D2D2D] mb-2">Get started</h1>
            <p className="text-[#6C757D]">Create your account to start building your AI support agent</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#6C757D]">
              ...
              <Link href="/auth/signin" className="text-[#4ECDC4] hover:text-[#00A085] font-medium">
                Sign in
              </Link>
            </p>
          </div>
